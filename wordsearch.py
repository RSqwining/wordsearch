...
words = ["ANTHRAX", "IMPETIGO", "SALMONELLA", "CHICKENPOX", "MUMPS", "THRUSH", "DENGUE", "FEVER", "MEASELES", "BIRD", 
         "FLUE", "SARS", "ROSEOLA", "PINK", "EYE", "KERATITIS", "CHLAMYDIA", "TONSILLITIS", "RUBELLA", "MENINGITIS", 
         "FLUE", "BRONCHITIS", "SMALLPOX", "PNEUMONIA", "LYME", "DISEASE", "COMMON", "COLD", "UVEITIS"]
